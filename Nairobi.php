            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <a class="dropdown-item" href="nairoads.php"><span class="item-text">INFRASTRUCTURE</span></a>
                        <div class="dropdown-items-divide-hr"></div>
                        <a class="dropdown-item" href="naihealth.php"><span class="item-text">HEALTH</span></a> <div class="dropdown-items-divide-hr"></div>
                        <a class="dropdown-item" href="naieducation.php"><span class="item-text">EDUCATION</span></a><div class="dropdown-items-divide-hr"></div>
                    ...
                    <div class="col-lg-12">
                      ...
                      <h2 style="color: white"><b><u>Counties Ranking</u> </b></h2>
                        ...
                        <div style="margin-top: 5px" class="text-container">
                            <h1>Nairobi County <span id="js-rotating">INFRASTRUCTURE, HEALTH, EDUCATION, SERVICES</span></h1>
                                  ...
                                  <h2>Star Rating</h2>
                                    <div style=" " >
                                     ...
                                     <h1 style="color:black; font-size: 16px" ><b><u>Current Projects</u></b></h1>
                                      ...
                                      $sql="SELECT * FROM developments Where category = 'active' And countyid= 3 ";
                        ...
                        <div class="form-popup" id="myForm2">
                              <div class="form-container" style="width: 250%; margin-left: -150%;" >
                                 ...
                                 <?php  
                                    ...
                                    $sql="SELECT * FROM developments Where category = 'Pending' And countyid= 3";
                                    $result=$mysqli->query($sql);
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h3 class="card-title">Roads In Nairobi County</h3>
                            <p>Enjoy our roads here in Nairobi County! We will make our county beautiful</p>
                           
                            <p class="price">Ask Questions <span></span></p>
                        </div>
                        <div class="button-container">
                            <a class="btn-solid-reg page-scroll" href="nairoads.php" style="background-color: #ff914d;border: none;">DETAILS</a>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h3 class="card-title">Education in Nairobi County</h3>
                            <p>We are trying to make our youths better! Different education platforms her in Nairobi</p>
                            
                            <p class="price">Ask Questions <span></span></p>
                        </div>
                        <div class="button-container">
                            <a class="btn-solid-reg page-scroll" href="naieducation.php" style="background-color: #ff914d; border: none; ">DETAILS</a>
                        </div> <!-- end of button-container -->
                    </div>
                    <!-- end of card -->
                    ...
                    <!-- Card -->
                     <div class="card" style="margin-left: -30px">
                        ...
                        <div class="card-body">
                            <h3 class="card-title">Health developments In Nairobi County</h3>
                            <p>Enjoy the different hospitals here in  Nairobi! We will make our county beautiful</p>
                           
                            <p class="price">Ask Questions <span></span></p>
                        </div>
                        <div class="button-container">
                            <a class="btn-solid-reg page-scroll" href="naihealth.php" style="background-color: #ff914d; border-color:#ff914d;border: none;">DETAILS</a>
                        </div> <!-- end of button-container -->
                    </div>
                    <!-- end of card -->
                    <div style="background-color: white;">
                    <h1 style="color: green">Feedback on  Nairobi County</h1>
...
$con->close();?>
      ...
      <form id='submit' action="nai2.php" method ="POST">
