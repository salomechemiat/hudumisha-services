...
<body>
	...
	<nav style="display: flex; flex-direction: row;" class="navbar navbar-inverse">
        ...
        <div class="navbar-header">
              ...
              <a class="navbar-brand" href="#">County Funds Transparency and Development Checker</a>
        </div>
   ...
   <!--  <ul class="nav navbar-nav navbar-right">
	...
	<div class="container-contact100">
		<div class="wrap-contact100">
			...
			<form style="margin-top: -50px;" action="countyedit.php" method="post" class="contact100-form validate-form" enctype="multipart/form-data">
              ...
              <input type="text" value="<?php echo $uid?>" name="id" hidden>
				...
				<div class="wrap-input100 rs1-wrap-input100 validate-input" data-validate="Type first name">
					<input id="first-name" class="input100" type="text" name="firstname" placeholder="Username">
