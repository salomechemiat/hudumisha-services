   ...
   <!--  <ul class="nav navbar-nav navbar-right">
	...
	<div class="container-contact100">
		<div class="wrap-contact100">
			...
			<form style="margin-top: -50px;" action="edit2.php" method="post" class="contact100-form validate-form" enctype="multipart/form-data">
              ...
              <input type="text" value="<?php echo $uid?>" name="id" hidden>
				...
				<div class="wrap-input100 rs1-wrap-input100 validate-input" data-validate="Type first name">
					<input id="first-name" class="input100" type="text" name="username" placeholder="constituency">
					<span class="focus-input100"></span>
				</div>
				<div class="wrap-input100 rs2-wrap-input100 validate-input" data-validate="Type last name">
					<input class="input100" type="text" name="county" placeholder="city">
					<span class="focus-input100"></span>
				</div>
				...
				<div class="wrap-input100">
					<input id="phone" class="input100" type="text" name="phonenumber" placeholder=" +1 800 000000">
					<span class="focus-input100"></span>
				</div>

				 <label class="label-input100" for="phone">Country</label>
				<div class="wrap-input100">
					<input id="phone" class="input100" type="text" name="country" placeholder=" Eg. ksh.100 per hour">
					<span class="focus-input100"></span>
				...
				<div class="wrap-input100">
					<input id="phone" class="input100" type="text" name="description" placeholder=" Description">
					<span class="focus-input100"></span>
