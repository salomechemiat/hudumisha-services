            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <a class="dropdown-item" href="mombasaroads.php"><span class="item-text">INFRASTRUCTURE</span></a>
                        <div class="dropdown-items-divide-hr"></div>
                        <a class="dropdown-item" href="mombasahealth.php"><span class="item-text">HEALTH</span></a> <div class="dropdown-items-divide-hr"></div>
                        <a class="dropdown-item" href="mombasaeducation.php"><span class="item-text">EDUCATION</span></a><div class="dropdown-items-divide-hr"></div>
                    ...
                    <div class="col-lg-12">
                      ...
                      <h2 style="color: white"><b><u>Counties Ranking</u> </b></h2>
                        ...
                        <div style="margin-top: 5px" class="text-container">
                            <h1>Mombasa County <span id="js-rotating">INFRASTRUCTURE, HEALTH, EDUCATION, SERVICES</span></h1>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h3 class="card-title">Roads In Mombasa County</h3>
                            <p>Enjoy our roads here in Mombasa County! We will make our county beautiful</p>
                           
                            <p class="price">Ask Questions <span></span></p>
                        </div>
                        <div class="button-container">
                            <a class="btn-solid-reg page-scroll" href="mombasaroads.php" style="background-color: #ff914d;border: none;">DETAILS</a>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h3 class="card-title">Education in Mombasa County</h3>
                            <p>We are trying to make our youths better! Different education platforms her in Mombasa</p>
                            
                            <p class="price">Ask Questions <span></span></p>
                        </div>
                        <div class="button-container">
                            <a class="btn-solid-reg page-scroll" href="mombasaeducation.php" style="background-color: #ff914d; border: none; ">DETAILS</a>
                        </div> <!-- end of button-container -->
                    </div>
                    <!-- end of card -->
                    ...
                    <!-- Card -->
                     <div class="card" style="margin-left: -30px">
                        ...
                        <div class="card-body">
                            <h3 class="card-title">Health developments In Mombasa County</h3>
                            <p>Enjoy the different hospitals here in Mombasa! We will make our county beautiful</p>
                           
                            <p class="price">Ask Questions <span></span></p>
                        </div>
                        <div class="button-container">
                            <a class="btn-solid-reg page-scroll" href="mombasahealth.php" style="background-color: #ff914d; border-color:#ff914d;border: none;">DETAILS</a>
                        </div> <!-- end of button-container -->
                    </div>
                    <!-- end of card -->
                    <div style="background-color: white;">
                    <h1 style="color: green">Feedback on Mombasa County</h1>
...
$con->close();?>
      ...
      <form id='submit' action="county2.php" method ="POST">
