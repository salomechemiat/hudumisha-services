...
$user=$_SESSION['uid'];
$sql="SELECT * FROM governor WHERE countyuserid='$user'";
  ...
  <div class="main-content">
    ...
    <div class="dropdown1-content">
      <? include("countbutton.php"); ?>
           <a href='counties.php?id=1'>Mombasa</a>
      ...
      <div class="container-fluid d-flex align-items-center">
        <div class="row">
          <div class="col-lg-7 col-md-10">
            <h1 class="display-2 " style="color: green"><b>Hello <?php echo $firstname?></b></h1>
            <p class="text-white mt-0 mb-5">This is your profile page. You can view yuur county and update different projects. you can also see the different achievements done so far and your rating</p>
            <a href="#" class="btn btn-info" onclick="openForm3()">Edit profile</a>
            <a href="#intro" class="btn btn-info" onclick="openForm()">Add Developments</a>
          </div>
        </div>
      </div>
    </div>
...
$user=$_SESSION['uid'];
$sql="SELECT countyuserid, countyname FROM county WHERE countyuserid='$user'";
$result = mysqli_query($con,$sql);
...
?>
  <form action="dev.php" class="form-container" method="POST" enctype="multipart/form-data">
     
    <h1>Head of <?php echo $countyname?> County</h1>
    <h2 style="float: center; margin-left: 10%; color: green;"><u>Input Available developments</u></h2>

    <label for="email"><b>Projects</b></label>
    ...
    <label for="psw"><b>County Id</b></label>
    <input type="text" placeholder="Enter County Id" name="id" required>
...
<div class="form-popup" id="form" >
  <form action="gedit.php" class="form-container" method="post" enctype="multipart/form-data">
    <h1>Edit Profile</h1>
     <input type='file' name='image'> 
    <label for="email"><b>Enter Email</b></label>
    <input type="text" placeholder="Change email" name="email" >

    <label for="psw"><b>Change Description</b></label>
            ...
            <div class="card-body pt-0 pt-md-4">
              ...
              <div class="text-center">
                <h3 style="color: green">
                  <?php echo $lastname?><span class="font-weight-bold">,<b><?php echo $gender?></b></span>
                </h3>
                  ...
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group focused">
                        ...
                        <input type="text" id="input-username" class="form-control form-control-alternative" placeholder="Username" value="<?php echo $firstname?>">
                      </div>
                    </div>
                    <div class="col-lg-6">
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group focused">
                        ...
                        <input id="input-address" class="form-control form-control-alternative" placeholder="Home Address" value="<?php echo $countyname?>" type="text">
                      </div>
                    </div>
                  </div>
                  <div class="row">
  ...
  <footer class="footer">
    <div class="row align-items-center justify-content-xl-between">
      <div class="col-xl-6 m-auto text-center">
        <div class="copyright">
          <p>Made with <a href="" target="_blank">Salome Monnthe</a> </p>
        </div>
      </div>
    </div>
  </footer>
