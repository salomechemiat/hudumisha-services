        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
          <ul class="navbar-nav mr-auto">
            <li class="nav-item active">
              <a class="nav-link" href="kilifi.php">Dashboard <span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item">
...
<div class="input-group mb-3">
  ...
  <h2 class="text-center">Kilifi Education Developments</h2> 
...
<?php  
  ...
  $sql="SELECT * FROM developments where countyid = 2 and type= 'education'  ";
